...
from evaluate_f import State, Parameters, eval_f
...
@pytest.mark.parametrize("x, p, expected_f", [
    ...
    (
        [State(0.0, 5.0), State(25.0, 5.0), State(40.0, 5.0)],
